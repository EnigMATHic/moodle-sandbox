    ...
    let sefHTML = `
        <div class='my-3 eng-sefs'>
            <a href='https://monash.az1.qualtrics.com/jfe/form/SV_9TZuRCZ8682e5ds' title='Engineering Student Experience Feedback Survey (SEFS)'>
                ...
                <img src='https://github.com/EnigMATHic/moodle-sandbox/SEFS-S1-2026-Footer-Purple.jpg' alt='Click here to complete the Engineering Student Experience Feedback Survey (SEFS) for a chance to win one of 5 100 dollar vourchers' width="100%"/>
            </a>
        </div>
    `;
